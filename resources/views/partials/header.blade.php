...
<div class="row logo-menu-container">
    ...
    <div class="hidden-xs hidden-sm col-md-12 col-lg-12 header-block">
        <table style="width: 56%;margin-left:22%;margin-right:22%;" border="0">
            ...
            <tr style="vertical-align: middle !important;">
                <td>&nbsp;</td>
                <td rowspan="3" style="width:220px;"><span onclick="gotoPage('home');" class="go-top"><img src="{{config('app.base_url')}}img/sqsqboxlesslogo.png" style="margin-right:-4px;border: 0px solid green;"/></span></td>
                <td>&nbsp;</td>
            </tr>
            <tr style="vertical-align: middle !important;">
    ...
    <div class="hidden-xs col-sm-12 hidden-md hidden-lg header-block">
        <div class="row logo-menu-row">
            <span onclick="gotoPage('home');" class="go-top"><img src="{{config('app.base_url')}}img/sqsqboxlesslogo.png" /></span>
        </div>
    ...
    <div class="hidden-xs hidden-sm col-md-12 col-lg-12 header-block" style="margin-bottom: 0px !important;">
        <div class="row logo-menu-row">
            <div>Welcome to the home of</div>
            <div style="margin-bottom: -10px !important;">animator Russ Etheridge</div>
        </div>
    </div>
</div>
